...
public class Constantes {
    ...
    public static final String EMAIL_USERNAME="tawfik.e@me.com";
    public static final String EMAIL_PASSWORD="E3YalN1pnubnw2HvjTfZzQ=="; // mot de passe crypté lancer le main pour le genere selon la clé utilisé
    public static final String EMAIL_SMTP_GMAIL="smtp.gmail.com"; //GMAIL mais faut activer la double connection sur gmail
    public static final String EMAIL_SMTP_HOTMAIL="smtp.live.com";  //Hotmail
